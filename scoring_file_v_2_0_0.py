...
data_sample = PandasParameterType(pd.DataFrame({"petal_length": pd.Series([0.0], dtype="float64"), "petal_width": pd.Series([0.0], dtype="float64"), "sepal_length": pd.Series([0.0], dtype="float64"), "sepal_width": pd.Series([0.0], dtype="float64")}))
